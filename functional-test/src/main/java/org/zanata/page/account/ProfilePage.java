...
public class ProfilePage extends BasePage {
    ...
    private By userInfoBy = By.id("profile-overview");
    private By textInfoBy = By.className("txt--meta");
    private By displayNameBy = By.className("l--push-all-0");
    ...
    private String getTextInfo(int position) {
        return waitForWebElement(waitForElementExists(userInfoBy), textInfoBy)
                .findElements(By.tagName("li")).get(position).getText();
    }
